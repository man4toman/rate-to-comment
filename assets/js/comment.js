jQuery(document).ready(function(){
        ...
        var pclass=jQuery(this).parent().attr('class'),
            ...
            jQuery.post(the_ajax_script.ajaxurl,{action:"add_fav_post",post_id:post_id,fav_val:fav_val},function(response){
    ...
    ///////////////////////////////////////////////////////
        ...
        var pclass=jQuery(this).parent().attr('class'),
           term_id= jQuery(this).attr('term_id'),
            ...
            jQuery.post(the_ajax_script.ajaxurl,{action:"add_fav_cat",term_id:term_id,fav_val:fav_val},function(response){
                jQuery('.'+pclass).html(response.substr(0,response.length-1));
             });
